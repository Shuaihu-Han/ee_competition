...
def parse_args():
    ...
    parser.add_argument("--epochs_num", type=int, default=2, help="Number of epochs.")
    parser.add_argument("--report_steps", type=int, default=1000, help="Specific steps to print prompt.")

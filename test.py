...
def main():
    ...
    if config.do_test:
        ...
        dev_set = Data(task='eval_without_oracle', fn='datasets/FewFC/data/dev.json', tokenizer=tokenizer, seq_len=config.seq_length, args_s_id=config.args_s_id, args_e_id=config.args_e_id, type_id=config.type_id)
